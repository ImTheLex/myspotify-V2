...
<article class="mb-2 body-grad-4 rounded-s br-1-s br-cus-c-7">
    <a class="items-center gap-x-3 px-2 rounded-s pr-2 py-2 hovr-cus-7  hovr-bg-cus-8" href="<?= isset($publicplaylists) && $publicplaylists ? "/controllers/PlaylistController.php?bOpenPlaylist={$publicplaylists[$i]['id']}" : ''?>">
