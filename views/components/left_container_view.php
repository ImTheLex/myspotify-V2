<!--------------------------------------Partie Gauche-------------------------------------------->
        <section class="col-b rounded-2 min-w-20 h-full make-container:left-container left-container">
            <div class="col-c rounded-2 p-2 gap-y-2 br-cus-2 br-a-1-s  bg-cus-6 top-left-container">
                <div class="icon-accueil">
                    <a onclick="toggle_playlists_display()" class="  gap-x-2 px-1 center" href="#" aria-label="Lien vers la page home">
                ...
                <div class="br-a-1-s br-cus-2 bg-cus-6 rounded-2 p-2 overf-a bottom-left-container">
                    <div class=" center min-cont-250:center-b px-1 bottom-left-top-container">
                        <button class="max-cont-250:hidden c-p bg-transparent h2 gap-x-2 flex justify-content-c align-items-ctext-cus-7 br-none biblio" >
                        ...
                        <div class="gap-x-2 flex justify-content-c align-items-cbiblio-icons">
                            <div class="p-rel rounded-100 create-playlist">
                                <a href="../controllers/PlaylistController.php?bCreatePlaylist">
                                    <div class="w-8 h-8 c-p hovr-cus-2 hovr-bg-cus-7  rounded-100 center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
                    ...
                    <div class=" gap-x-6 pb-2 px-1 br-b-1-s max-cont-250:center gap-y-2 max-cont-200:fw-w  left-container-filter">
                    ...
                    <div class="max-cont-300:pt-2 left-scrollable-container">
                        <div class="p-rel px-2 gap-x-2 py-1 hidden -hovr-scale-9 min-cont-250:center-b form-left-side-container">
                            ...
                            <form class=" bg-transparent ml-10 rounded-1 center" action="">
