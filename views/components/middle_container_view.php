...
<section class="col-b p-rel w-full h-full br-cus-c-2 br-1-s rounded-sm middle-container">
    <?php if(isset($userdatas)): ?>
        <div class="py-2 px-6 p-abs d-fx jc-sb w-full top-middle-container">
            <div class="items-center gap-x-1 top-middle-left-container">
                <p class="c-na center w-10 h-10 bg-black rounded-full c-p" >
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="10" viewBox="0 0 320 512">
                        <path opacity="1" fill="currentColor" d="M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/>
                    </svg>
                </p>
                <p class="center w-10 h-10 bg-black rounded-full c-p">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="10" viewBox="0 0 320 512">
                        <path opacity="1" fill="currentColor" d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/>
                    </svg>
                </p>
            </div>
