            ...
            <tr class="br-b-4-s br-cus-c-1 bg-cus-12 hovr-bg-cus-9 ">    
                <td class="py-2 px-2 ta-s">
                    <div class="flex align-items-c">
                        <?= $k + 1?>
                        <audio id="audio-<?=$k?>">
                            <source src="<?= $artisttodisplaytrack['audio_link']?>" type="audio/mpeg">
                        </audio>
                        <button type="button"  class=" c-p bg-transparent border-none text-cus-7 hovr-text-cus-5" onclick="playAudio(event)">
                            <svg xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 384 512">
                        ...
                        <button type="button"  class=" c-p bg-transparent border-none text-cus-7 hovr-text-cus-5" onclick="pauseAudio(event)">
