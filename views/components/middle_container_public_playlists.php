...
<article class="mb-2 w-fit public-playlist">
    <a class="block px-2 bg-cus-3 rounded-2 pr-2 py-2 hovr-bg-cus-8 br-a-1-s br-cus-c-7" href="<?= isset($publicplaylists) && $publicplaylists ? "/controllers/PlaylistController.php?bOpenPlaylist={$publicplaylists[$i]['id']}" : ''?>">
