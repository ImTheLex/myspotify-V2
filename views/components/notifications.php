    <div class="p-abs mt-12 w-full bg-cus-8 rounded-s p-2 notification">
        <ul class="flex-col gap-y-2">
            <?php foreach($unreadtickets as $unreadticket):?>
                <li class="br-l-4-s br-cus-c-10 bg-cus-6 gap-x-3 p-2 rounded-s center-b">
                    <div>
                        <h5 class="">Sujet:</h5>
                    ...
                    <a href="/controllers/TicketController.php?bIsReadTicket=<?=$unreadticket['id']?>" class="center hovr-white">
